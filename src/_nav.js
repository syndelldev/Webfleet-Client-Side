...
import mapIcon from './assets/images/mapplot.png'
...
import mapNav from './assets/images/mapNav.svg'
import VehicleTracking from './views/User-Management/UserList'
...
const _nav = [
  ...
  },
  {
    ...
    items: [
      ...
      // {
      //   component: CNavItem,
      //   name: 'Vehicle Trip Request',
      //   to: '/vehicle-management/vehicle-fleet',
      //   icon: <img src={mapNav} height={15} style={{ marginRight: 5 }} />
      // },
      {
        component: CNavItem,
        name: 'Vehicle Tracking',
        to: '/vehicle-management/vehicle-tracking',
  ...
  },
  {
    ...
    items: [
      ...
      //   to: '/driver-management/driver-trip-history',
      //   icon: <img src={Trip} height={11} style={{ marginRight: 5 }} />,
      // },
    ],
  },
  ...
  },
  {
    ...
    icon: <img src={Billing} height={15} style={{ width: 45, padding: '0px 12px', height:18 }} />,
  },
  // {
  //   component: CNavGroup,
  //   name: 'Other services',
