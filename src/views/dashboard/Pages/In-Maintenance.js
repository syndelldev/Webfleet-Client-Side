...
const Inactive = (props) => {
  ...
  const currentVehicle = filterResult.slice(indexOfFirstVehicle, indexOfLastVehicle)
    ...
    <div className="div_userDetails">
      ...
      >
        <CTableDataCell className="badgecontent ps-3">
          <CBadge className="badgestyles">
            <div className="blueradius"></div>
          </CBadge>
        </CTableDataCell>
      ...
      >
        ...
        <h1 className="hh ms-2" style={{ margin: '0' }}>
          There are no vehicle in maintenance
        </h1>
      </CCol>
           </>}
      </div>
