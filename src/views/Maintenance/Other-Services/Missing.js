...
import drivermod from '../../../assets/images/Ellipse 89.svg'
...
const filterResult = VehicleData.filter((item) => item.status === 'Missing')
...
<CTableDataCell className='badgecontent ps-5'><CBadge className='badge_styles_circle'><div className='redradius' style={{ background:"rgb(244 229 68 / 62%)" }}></div></CBadge></CTableDataCell>
      <h1 className='hh ms-2'>Missing</h1>
</CCol>
