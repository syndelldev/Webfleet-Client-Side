...
const Inshop = (props) => {
  ...
  const filterResult = VehicleData.filter((item) => item.status === 'Idle' && item.operator === 'None')
  ...
  const currentIdleVehicle = filterResult.slice(indexOfFirstVehicle, indexOfLastVehicle)
