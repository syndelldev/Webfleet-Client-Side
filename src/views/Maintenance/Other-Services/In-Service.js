...
const InService = (props) => {
  ...
  const filterResult = VehicleData.filter((item) => item.status === 'In service')
  // userDetails.push(filterResult)
    ...
    <div className="div_userDetails">
      <CForm className=" row g-3 w-100">
        <CCol xs="auto" className="w-100">
          <CTableDataCell className="badgecontent ps-5">
            <CBadge className="badgestyle">
              <div className="greenradius"></div>
            </CBadge>
          </CTableDataCell>
          <h1 className="hh ms-2">In Service</h1>
        </CCol>
      </CForm>
      ...
      <div className="allUserTable" style={{ overflowX: 'auto' }}>
        <CTable className="alluserCtable" style={{ tableLayout: 'fixed' }}>
          <CTableHead>
            <CTableRow>
              <CTableHeaderCell className="tablecell user_tableHead ps-5" style={{ width: 160 }}>
                Registration No
              </CTableHeaderCell>
              <CTableHeaderCell className="tablecell tablecell_id user_tableHead ps-3">
                Year
              </CTableHeaderCell>
              ...
              <CTableHeaderCell className="tablecellvehicle user_tableHead">
                Driver Name
              </CTableHeaderCell>
            </CTableRow>
          </CTableHead>
